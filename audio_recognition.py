...
def audio_recognition():
    ...
    ThreeDbox_chessboard = re.search('现实增强',result_str)
    terminate=re.search('立刻停止',result_str)
    Wechat_cloudmap=re.search('微信云图',result_str)
    Find_chorus=re.search('歌曲识别',result_str)
    ...
    if liveness_detect:
        ...
        return 2
    elif ThreeDbox_chessboard:
        return 4
    elif Wechat_cloudmap:
        return 6
    elif terminate:
        return 5
    elif Find_chorus:
